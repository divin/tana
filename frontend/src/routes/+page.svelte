<script lang="ts">
    ...
    function getMediaType(
        ...
        if ("watched_date" in media) return "movie";
    ...
    {:else}
        ...
        <section class="welcome-section">
            ...
            <p class="welcome-subtitle">
                Track your favorite movies, books, and TV series all in one
                place
            </p>
        </section>
        ...
        {#if !recentMedia || (recentMedia.movies.length === 0 && recentMedia.series.length === 0 && recentMedia.books.length === 0)}
            <div class="empty-state">
                <p>
                    No media added yet. Start tracking your favorite movies, TV
                    shows, and books!
                </p>
